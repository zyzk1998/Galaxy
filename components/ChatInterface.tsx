      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
            <div 
              className={`max-w-[80%] p-4 rounded-xl shadow-lg ${
                msg.role === 'user' 
                  ? 'bg-galaxy-primary text-white rounded-br-none' 
                  : msg.type === 'error'
            ...
            >
              ...
              {msg.type === 'tool_call' ? (
                 <div className="font-mono text-sm bg-black/30 p-2 rounded border-l-2 border-galaxy-accent">
                 ...
                 <div className="font-mono text-sm bg-green-900/20 p-2 rounded border-l-2 border-green-500">
                    <div className="text-green-500 mb-1 flex items-center gap-2">
        ...
        {isLoading && (
          <div className="flex justify-start w-full">
            <div className="bg-gray-800 p-4 rounded-xl rounded-bl-none border border-galaxy-accent/30 w-full max-w-md">
                ...
                <div className="text-sm text-gray-300 font-mono whitespace-pre-wrap animate-pulse">
                    {loadingText || '正在处理中...'}
                </div>
            </div>
          </div>
      ...
      <div className="p-4 bg-gray-800 border-t border-gray-700">
        <div className="flex items-end gap-2 max-w-4xl mx-auto">
          ...
          <textarea
            ...
            className="flex-1 bg-gray-900 text-white rounded-lg p-3 resize-none focus:outline-none focus:ring-1 focus:ring-galaxy-primary border border-gray-700 disabled:opacity-50"
            rows={1}
          ...
          <button
            ...
            className={`p-3 rounded-lg transition-all ${
              isLoading || !input.trim() 
                ...
                : 'bg-galaxy-primary text-white hover:bg-purple-600 shadow-lg'
            }`}
          >
